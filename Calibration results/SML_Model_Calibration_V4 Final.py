...
#os.chdir(r"C:\Users\USNHIT\OneDrive - USNH\Roozbeh PhD research\Project 7 SML Water-Energy modeling\System Dynamics\SML Python SD Model")
...
plt.xlabel('Time Steps (Minutes)', fontweight='bold', fontsize=27)

# Set y-axis label with larger font size
plt.ylabel('Well Depth (in)', fontweight='bold', fontsize=27)

# Set x and y ticks font size and format x-axis ticks
...
plt.legend(fontsize=18, loc='upper right', shadow=True, fancybox=True, bbox_to_anchor=(0.3, 0.15), frameon=True)

# Add shade for data before 72,000
plt.axvspan(-100, 72_000, color='lightgrey', alpha=0.4)

# Add shade from x-axis step 72,000 to the end
plt.axvspan(72_000, 85_000, color='lightgrey', alpha=0.7)

# Add text boxes
plt.text(0.405, 0.75, "    (85%)\nMSE=1.60\nMAE=0.99\nR2=96.94%", transform=plt.gca().transAxes, fontsize=16, bbox=dict(facecolor='white', alpha=0.5))
plt.text(0.86, 0.75, "    (15%)\nMSE=1.16\nMAE=0.69\nR2=71.80%", transform=plt.gca().transAxes, fontsize=16, bbox=dict(facecolor='white', alpha=0.5))

# Add text boxes
plt.text(40_000, 174, "Calibration", fontsize=18, fontweight='bold', ha='center', va='center')
plt.text(78_500, 174, "Validation", fontsize=18, fontweight='bold', ha='center', va='center')
