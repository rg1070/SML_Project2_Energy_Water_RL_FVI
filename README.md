...
This project presents the sample codes of a dynamic water-energy system at Shoals Marine Lab, incorporating both an **energy sub-model** and a **water sub-model**. It was designed to evaluate the impacts of operational decisions on cost, environmental outcomes, and water system reliability. The dynamic model was further optimized using Fitted Value Iteration, briefly explained below.
